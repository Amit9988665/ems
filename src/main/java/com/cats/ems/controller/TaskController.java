...
public class TaskController {
	...
	@Operation(summary = "${allinfo.message}")
	@TrackExecutionTime
	public List<TaskStatusDTO> getAllTask(HttpServletRequest httpServletRequest, @RequestParam(name="startDate", required = false) String startDate) {
		return taskService.getAllTask(httpServletRequest,startDate);
	}
